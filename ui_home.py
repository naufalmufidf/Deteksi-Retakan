...
################################################################################
## Form generated from reading UI file 'homeTUMaYP.ui'
##
...
"border-radius: 9%;")
    ...
    def retranslateUi(self, Home):
        ...
        self.label_credits.setText(QCoreApplication.translate("Home", u"Final project by : C2", None))
        self.btn_pre.setText(QCoreApplication.translate("Home", u"Pre-Processing", None))
        self.btn_detect.setText(QCoreApplication.translate("Home", u"Deteksi Retakan", None))
