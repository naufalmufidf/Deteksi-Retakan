...
################################################################################
## Form generated from reading UI file 'loading_screenyWzEhN.ui'
##
...
"}")
    ...
    def retranslateUi(self, Loading):
        ...
        self.label_title.setText(QCoreApplication.translate("Loading", u"<html><head/><body><p>Pre-Processing</p></body></html>", None))
        self.label_desc.setText(QCoreApplication.translate("Loading", u"A step to prepare image \n"
"for next process", None))
        self.label_loading.setText(QCoreApplication.translate("Loading", u"loading...", None))
        self.label_credits.setText(QCoreApplication.translate("Loading", u"Final project by : C2", None))
    # retranslateUi
